...
#import "YYYImageData.h"


#pragma mark SVIndefiniteAnimatedView

@interface YYYIndefiniteAnimatedView ()

@property (nonatomic, strong) CAShapeLayer *indefiniteAnimatedLayer;

@end

@implementation YYYIndefiniteAnimatedView
...
- (CAShapeLayer *)indefiniteAnimatedLayer {
    if (!_indefiniteAnimatedLayer) {
        ...
        maskLayer.contents = (id) [[YYYImageData indefiniteAnimatedImage] CGImage];
